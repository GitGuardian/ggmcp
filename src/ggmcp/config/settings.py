...
class Settings(BaseSettings):
    ...
    def requested_scopes(self) -> list[str]:
        ...
        against :data:`ggmcp.api.scopes.ALL_SCOPES`. Returns an empty
        list when neither env var is set.

        Raises:
            ValueError: if any requested scope is not a known scope.
        """
        from ggmcp.api.scopes import validate_scopes
    ...
    def effective_scopes(self) -> list[str]:
        ...
        from ggmcp.api.scopes import ALL_SCOPES, SCOPES_SUPPORTED_IN_SELF_HOSTED
