...
class TestListIncidents:
    ...
    @pytest.mark.asyncio
    async def test_list_incidents_basic(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_basic"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_with_status_filter(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_with_status_filter"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_with_severity_filter(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_with_severity_filter"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_with_ordering(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_with_ordering"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_with_date_filter(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_with_date_filter"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_get_all(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_get_all"):
...
class TestGetIncident:
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_get_incident(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_get_incident"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_get_incidents_batch(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_get_incidents_batch"):
...
class TestIncidentDetails:
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incident_members(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incident_members"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incident_notes(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incident_notes"):
            # First get an incident ID
            incidents = await real_client.list_incidents(per_page=1)
            if not incidents["data"]:
                pytest.skip("No incidents available for testing")
...
class TestListIncidentsForMcp:
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_basic(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_basic"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_status_filter(self, real_client, use_cassette):
        """
        ...
        THEN we should receive only triggered incidents
        """
        with use_cassette("test_list_incidents_for_mcp_with_status_filter"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_severity_filter(self, real_client, use_cassette):
        """
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_ordering(self, real_client, use_cassette):
        """
        ...
        THEN we should receive incidents in descending date order
        """
        with use_cassette("test_list_incidents_for_mcp_with_ordering"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_source_criticality(self, real_client, use_cassette):
        """
        ...
        THEN we should receive incidents (filter applied)
        """
        with use_cassette("test_list_incidents_for_mcp_with_source_criticality"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_detector_filter(self, real_client, use_cassette):
        """
        ...
        THEN we should receive incidents (filter applied)
        """
        with use_cassette("test_list_incidents_for_mcp_with_detector_filter"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_presence_filter(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_with_presence_filter"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_unassigned(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_unassigned"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_pagination(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_pagination"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_combined_filters(self, real_client, use_cassette):
        """
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_search(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_with_search"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_detector_category(self, real_client, use_cassette):
        """
        ...
        THEN we should receive incidents (filter applied)
        """
        with use_cassette("test_list_incidents_for_mcp_with_detector_category"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_issue_tracker(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_with_issue_tracker"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_feedback(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_with_feedback"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_publicly_shared(self, real_client, use_cassette):
        """
        ...
        THEN we should receive incidents (filter applied)
        """
        with use_cassette("test_list_incidents_for_mcp_with_publicly_shared"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_secret_manager_type(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_with_secret_manager_type"):
            result = await real_client.list_incidents_for_mcp(
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_date_filter(self, real_client, use_cassette):
        """
        Test listing incidents filtered by date range.
        ...
        THEN we should receive incidents (filter applied)
        """
        with use_cassette("test_list_incidents_for_mcp_with_date_filter"):
            result = await real_client.list_incidents_for_mcp(
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_teams(self, real_client, use_cassette):
        """
        ...
        THEN we should receive incidents (filter applied)
        """
        with use_cassette("test_list_incidents_for_mcp_with_teams"):
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_validity(self, real_client, use_cassette):
        """
    ...
    @pytest.mark.vcr_test
    @pytest.mark.asyncio
    async def test_list_incidents_for_mcp_with_score_filter_and_ordering(self, real_client, use_cassette):
        """
        ...
        """
        with use_cassette("test_list_incidents_for_mcp_with_score_filter_and_ordering"):
            result = await real_client.list_incidents_for_mcp(
                score__ge=50,
                ordering="-score",
                page_size=10,
