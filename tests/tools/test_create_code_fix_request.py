...
class TestCreateCodeFixRequest:
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_single_issue_success(
        ...
        mock_response = {
            "message": "Created 1 code fix requests for 3 locations"
        }
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_multiple_issues_success(
        self, mock_gitguardian_client
    ):
        """
        ...
        # Mock the client response
        mock_response = {
            "message": "Created 2 code fix requests for 5 locations"
        }
        mock_gitguardian_client.create_code_fix_request = AsyncMock(
            return_value=mock_response
        )
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_feature_disabled(
        self, mock_gitguardian_client
    ):
        """
        ...
        with pytest.raises(ToolError) as excinfo:
            await create_code_fix_request(
                CreateCodeFixRequestParams(
                    locations=[LocationToFix(issue_id=12345, location_ids=[67890])]
                )
            )
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_too_many_locations(
        self, mock_gitguardian_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_no_valid_locations(
        self, mock_gitguardian_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_already_being_fixed(
        self, mock_gitguardian_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_insufficient_permissions(
        self, mock_gitguardian_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_api_key_not_configured(
        self, mock_gitguardian_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_generic_error(
        self, mock_gitguardian_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_response_without_message(
        self, mock_gitguardian_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_create_code_fix_request_with_many_locations(
        self, mock_gitguardian_client
    ):
        """
        ...
        # Mock the client response
        mock_response = {
            "message": "Created 5 code fix requests for 15 locations"
        }
        mock_gitguardian_client.create_code_fix_request = AsyncMock(
            return_value=mock_response
        )
        ...
        locations = [
            LocationToFix(issue_id=100 + i, location_ids=[1000 + i, 2000 + i, 3000 + i])
            for i in range(5)
        ]

        # Call the function
        result = await create_code_fix_request(
            CreateCodeFixRequestParams(locations=locations)
        )
